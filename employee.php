			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						...
						<button class="btn btn-success btn-sm btn-block col-md-3 float-right" type="button" id="new_emp_btn"><span class="fa fa-plus"></span> Add Employee</button>
					</div>
					<div class="card-body">
								...
								<?php
									...
									$dept = $conn->query("SELECT * from department order by name asc");
										...
										while($row=$pos->fetch_assoc()):
										 ...
										 endwhile;
									$employee_qry=$conn->query("SELECT * FROM employee") or die(mysqli_error($con));
