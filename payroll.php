			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						...
						<button class="btn btn-success btn-sm btn-block col-md-3 float-right" type="button" id="new_payroll_btn"><span class="fa fa-plus"></span> Add Payroll</button>
					</div>
					<div class="card-body">
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
									...
									$payroll=$conn->query("SELECT * FROM payroll order by date(date_from) desc") or die(mysqli_error($con));
